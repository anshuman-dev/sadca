...
<form className='max-w-[1100px] my-auto mt-24 ml-80 bg-white rounded-1g' style={{borderTopRightRadius: 15, borderBottomLeftRadius: 15, border: 'solid-outset'}}><br />
            ...
            <div className="tooltip"><button class="flex mx-auto mt-8 text-white bg-green-600 border-0 py-8 px-20 focus:outline-none hover:bg-green-900 text-lg" style={{borderBottomRightRadius: 15, borderTopLeftRadius: 15, border: 'solid-outset'}}>Add File</button></div>
...
export default Dashboard_purchase